const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_ABRA]                  = {{EVO_LEVEL, 16, SPECIES_KADABRA},
                                       {EVO_LEVEL, 99, SPECIES_ABRA2}},
    [SPECIES_ABRA2]                 = {{EVO_LEVEL, 100, SPECIES_ABRA3}},
...
#endif
    [SPECIES_CHANSEY]               = {{EVO_LEVEL, 35, SPECIES_BLISSEY}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_MUNCHLAX]              = {{EVO_LEVEL, 32, SPECIES_SNORLAX}},
    [SPECIES_RIOLU]                 = {{EVO_LEVEL, 32, SPECIES_LUCARIO}},
    ...
    [SPECIES_WOOBAT]                = {{EVO_LEVEL, 26, SPECIES_SWOOBAT}},
    ...
    [SPECIES_SWADLOON]              = {{EVO_LEVEL, 32, SPECIES_LEAVANNY}},
    ...
    [SPECIES_KARRABLAST]            = {{EVO_LEVEL, 32, SPECIES_ESCAVALIER}},
    ...
    [SPECIES_PHANTUMP]              = {{EVO_LEVEL, 18, SPECIES_TREVENANT}},
    ...
    [SPECIES_MEOWTH_ALOLAN]         = {{EVO_LEVEL, 22, SPECIES_PERSIAN_ALOLAN}},
